...
const HOBBIES = [
  ...
  { t: "Photography", s: "Aesthetic landscapes and portraits with my Sony Alpha 6400",
  ...
  return (
    <main>
      <section className="container-reading page-intro">
        ...
        <h1 className="h1">I like anything and everything, and the people that accompany it</h1>
      </section>
      ...
      <section className="container-reading about-layout">
        <div className="prose">
          <p>
            ...
            experimenting with seemingly random interactions that result in riveting behavior.
          ...
          <p>
            ...
            I&apos;ve taken an interest in trying new hobbies, learning to crochet being my
            latest interest.
          </p>
          <p>
